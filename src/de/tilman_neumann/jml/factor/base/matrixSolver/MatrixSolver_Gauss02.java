 ...
 * 
 * The main improvement came from adopting the new base class due to Dave McGuigan.
 * 
 * Further improvements:
 * - for small N: the explicit control of the biggest column indices of all rows, permitting to find the pivot row without iterating over all rows.
 * - for large N: the selection of pivot rows, leading to sparser matrices during the solution procedure.
 * 
